...
@org.springframework.test.context.ContextConfiguration(classes = {com.ikea.TestApplication.class, com.ikea.warehouse_query_api.controller.ProductController.class})
class ProductControllerTest {
    ...
    void getProducts_returnsTransformedResponse() throws Exception {
        ...
        when(productService.getAllProducts(0, 10)).thenReturn(List.of(data));
